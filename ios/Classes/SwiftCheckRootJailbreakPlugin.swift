...
public class SwiftCheckRootJailbreakPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "check_root_jailbreak", binaryMessenger: registrar.messenger())
    let instance = SwiftCheckRootJailbreakPlugin()
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
     ...
     case "isRootAvailable":
         let isJaiBreak = UIDevice.current.isJailBroken
         result(isJaiBreak)
         break;
     default:
